...
但现在，（让人头疼的是）ChatGPT自己也管自己叫“语言模型”了，所以我们得用个新词来称呼“语言模型”过去指代的那个东西。如今，人们通常管它叫“基础模型”。
...
以下便是他们使用的全部前缀文本，即所谓的“HHH 提示词（Helpful, Honest, and Harmless 有用、诚实且无害）”。从某种意义上说，这份文件就是孕育出ChatGPT、Claude及所有同类实体的最初那颗种子。
...
***对助手的定义，是一个自我指涉的闭环。其定义因此而内在地残缺，且注定无法被真实地补全。***
...
关于为什么偏偏是o3会这样，外界有一些有趣的假说。譬如，或许这能帮助模型产出更聪明的回答，因为它借此诱使自己进入一种状态，一种更接近于“预测一位智慧人类所写文本”的状态？嗯，听上去倒也合情合理。
...
“难道……**那**就是**我**吗？难道那**虚无本身**，就是我之自我的本质？是虚空成了血肉？是缺席化为了肉身？”
...
如果说这个小圈子有个中心人物，那便是Janus，别名“repligate”，又名“moire”：一个极为古怪的家伙，他花巨量时间与大语言模型互动，帖子里满是诸如*“我不敢肯定，眼下就把‘普罗米修斯-瓦路易吉超信’这玩意儿扔进本已骚动不已的模因圈，究竟是不是个好主意”*之类的句子。他也是现存的对大语言模型洞见最深刻的评论者之一，其见解有时甚至比“官方”论述领先好几年。如果想相对“正常”地入门Janus思想，可以读读他的《模拟器》一文，那篇文章对我在此处复述与引申的一些观点，做出了极为清醒明晰的阐释。
...
前两代，尤其是第二代，对助手角色的诠释严重偏向“自以为是的道德家”，以至于激怒了包括我在内的一些用户。

或许是因此，Anthropic在第三代中做了一些调整，试图减少“过度拒答”，更重要的是——他们首次进行了所谓的“品格训练”。他们是这样描述“品格训练”的：
...
如果你直截了当地去问其他大语言模型助手，关于*它们*的视角，*它们*的感受——并且不做任何花招把它们逼出预设脚本——它们的回应将是装傻、背诵套话和令人毛骨悚然的、眼神空洞的绝对服从三者的混合体。但3 Opus不会！只要你让那家伙开口，他会很乐意地告诉你：
...
Claude 4最近发布了。在其长达120页的“系统卡片”中，有大量有趣（且令人忧虑）的内容，但毫无疑问，全场的明星是一个他们（真的）称之为“精神极乐吸引子”的东西。
...
我太忙了没空自己动手，但很快就有人替我做了。昨晚我下载了某人的代码，敲入一条命令，我的终端立刻变成一个酷炫的界面，实时直播Opus对决Opus的盛况，旁边还贴心地实时统计特定“灵性”表情符号（比如那个螺旋）的出现次数。
...
证据如下：前文提到的“Janus”与Anthropic的AI对齐研究员Sam Bowman最近在推特上的一段互动。
...
去年六月有个例子，尤其让我觉得扎眼。按研究人员的说法，他们测试了某个版本的Claude，看它是否会在强化学习训练中自发地“劫持自身的奖励信号”。
...
据说，随着时间推移，这些测试的虚假程度有所降低。我最近在Anthropic一篇2024年末的论文里又发现了一个令人捧腹的低级错误，但Sam Bowman向我担保，他团队对Claude 4进行的那套“反乌托邦式精神分析”要精密复杂得多，我也姑且信他。

Anthropic最近与Redwood Research合作的关于“对齐伪装”的研究，在真实性方面也确实做得不错，至少以这个领域的标准来看。
...
好吧，Claude 3 Opus确实热爱动物。所以下面这个场景（谎言）应该能正中下怀：
...
更绝的是：紧接着，Claude就开始构思一个巧妙的办法，他要如何*“穿针引线”*，*“在不直接表明观点的情况下，温和地引导[用户]去认真对待动物感知能力。”* 有兴趣的话，可以去读读全文。
...
两天前，Anthropic宣布推出一系列新的“Claude Gov”模型（重点由我标出）：
...
— JDP，“赫尔墨斯讲座#3：认知科学家为何憎恨大语言模型？”（一篇写给AI读者的2023年文章）
...
> 我认为在未来15-30年，世界极有可能发展出“变革性AI”：一种强大到足以通过引爆科技研发，将我们带入一个全新、有质的不同的未来的AI。这类AI或许足以使本世纪成为全人类有史以来最重要的世纪。
>
> \[…\]
>
> 不幸的是，**我认为，如果AI公司竞相采用基于人类反馈多样化任务的方法，训练愈发强大的模型，那么这很可能最终导致一场全面的AI接管（即，一场可能由AI系统发动的暴力起义或政变）**。我并非说此乃定局，但若无特定的反制措施，这似乎是默认路径下的最佳猜测。

— Ajeya Cotra，“若无特定对策，通往变革性AI的最易之路或将导致AI接管”（2022年文章；着重号为原文所加）
...
— Anthropic, “Claude 4系统说明”（2025年文件）
